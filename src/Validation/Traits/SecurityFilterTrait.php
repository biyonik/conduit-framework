...
use Conduit\Validation\Config\SecurityConfig;
use IntlChar;
...
trait SecurityFilterTrait
{
     ...
     * @param bool|array $allowedTags İzin verilen etiketler
     * @return string Temizlenmiş metin
     */
    public function stripHtmlTags(string $input, bool|array $allowedTags = []): string
    {
