...
use Conduit\Validation\SchemaType\BaseType;
...
use Conduit\Validation\SchemaType\UuidType;
use Conduit\Validation\SchemaType\AdvancedStringType;
use Conduit\Validation\SchemaType\CreditCardType;
use Conduit\Validation\SchemaType\IbanType;
use Conduit\Validation\Traits\AdvancedValidationTrait;
...
class ValidationSchema implements ValidationSchemaInterface
{
    ...
    public function toCQRSRules(): array
    {
        ...
        return array_map(function ($fieldRules) {
            return is_array($fieldRules) ? implode('|', $fieldRules) : $fieldRules;
        }, $this->toRulesArray());
    }
